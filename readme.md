...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 18 | 🐛 0 | 🌐 Shell | 📅 2026-03-18.
...
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 646 | 🐛 25 | 🌐 Python | 📅 2025-12-25 - A python decoder for Mode S and ADS-B signals.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,719 | 🐛 54 | 🌐 JavaScript | 📅 2026-03-08 - A great way to view your ADS-B data.
