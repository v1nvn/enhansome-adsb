...
# <a style="color: inherit" href="https://github.com/rickstaa/awesome-adsb">Awesome ADS-B</a> [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![GitHub contributors](https://img.shields.io/github/contributors/rickstaa/awesome-adsb?color=geen)](https://github.com/rickstaa/awesome-adsb/graphs/contributors) ⭐ 290 | 🐛 0 | 🌐 HTML | 📅 2026-02-25 [![GitHub Repo stars](https://img.shields.io/github/stars/rickstaa/awesome-adsb)](https://github.com/rickstaa/awesome-adsb/stargazers) ⭐ 290 | 🐛 0 | 🌐 HTML | 📅 2026-02-25 <!-- omit in toc -->
...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 18 | 🐛 0 | 🌐 Shell | 📅 2026-03-23.
...
* [dump1090](https://github.com/MalcolmRobb/dump1090) ⭐ 1,096 | 🐛 39 | 🌐 C | 📅 2024-08-14 - A simple Mode S decoder for RTLSDR devices.
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 653 | 🐛 25 | 🌐 Python | 📅 2025-12-25 - A python decoder for Mode S and ADS-B signals.
* [readsb](https://github.com/wiedehopf/readsb) ⭐ 584 | 🐛 10 | 🌐 C | 📅 2026-02-28 - ADS-B decoder swiss knife.
* [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) ⭐ 121 | 🐛 10 | 🌐 Python | 📅 2026-03-21 - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
...
* [adsb\_actions](https://github.com/eastham/adsb_actions) ⭐ 3 | 🐛 8 | 🌐 Python | 📅 2026-03-17 - Python tool to detect, act on, and visualize ADS-B traffic and events.

### Feeding

* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 472 | 🐛 2 | 🌐 Shell | 📅 2026-01-28 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
* [adsbfi/adsb-fi-scripts](https://github.com/adsbfi/adsb-fi-scripts) ⭐ 143 | 🐛 0 | 🌐 Shell | 📅 2025-08-29 - Easy to use feeder install script for feeding to adsb.fi.
* [adsblol/feed](https://github.com/adsblol/feed) ⭐ 72 | 🐛 3 | 🌐 Shell | 📅 2024-10-18 - Easy to use, container-based MLAT/ADS-B/ACARS/VDL2 multi feed client. Powered by [SDR-Enthusiasts](https://github.com/sdr-enthusiasts) images.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,723 | 🐛 53 | 🌐 JavaScript | 📅 2026-03-20 - A great way to view your ADS-B data.
* [amnesica/BelugaProject](https://github.com/amnesica/BelugaProject) ⭐ 76 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-03 - A web application that displays data of one or multiple, local ADS-B feeders and AIS-data along with additional information on a map interface in the browser.
* [Grafana](https://grafana.com/) - Open source analytics and monitoring solution for every database.

### Apps

* [d4rken/adsb-meta-tracker](https://github.com/d4rken/adsb-meta-tracker) ⚠️ Archived - An Android ADS-B Meta Tracker that shows metadata about ADS-B aggregators.
* [AirPing](https://airping.app) - An iOS app that turns your tar1090 or readsb instance into a mobile flight tracker.

### Social

* [Jxck-S/plane-notify](https://github.com/Jxck-S/plane-notify) ⭐ 2,539 | 🐛 11 | 🌐 Python | 📅 2026-02-05 - Notify if a selected plane has taken off or landed using OpenSky or ADS-B Exchange data.
* [docker-planefence](https://github.com/kx1t/docker-planefence) ⭐ 4 | 🐛 0 | 📅 2025-03-12 - A little tool that can be used to log, display and tweet the aircraft that come within range of your receiver (i.e. the fence).

## ADS-B Derived Data

* [aircraft-flight-schedules](https://github.com/MrAirspace/aircraft-flight-schedules) ⭐ 22 | 🐛 0 | 📅 2026-03-08 - Open-source datasets featuring global, high-level flight schedules extracted from worldwide aircraft ADS-B position transmissions (2024+ onwards). Covers all flights globally as long as within coverage of the [ADSBlol](https://adsb.lol/) initiative.
...
> **TODO:**
> Please [create a pull request](https://github.com/rickstaa/awesome-adsb/pulls) ⭐ 290 | 🐛 0 | 🌐 HTML | 📅 2026-02-25 if you know people in the ADS-B space that are worth following.

Who else should we [be following](https://github.com/rickstaa/awesome-adsb/issues/new?assignees=\&labels=\&template=suggestion.yaml) ⭐ 290 | 🐛 0 | 🌐 HTML | 📅 2026-02-25?
...
Contributions of any kind are welcome 💙! Please check out the [contributing guidelines](origin/contributing.md).
...
This project exists thanks to all the people [that contributed](https://github.com/rickstaa/awesome-adsb/graphs/contributors) ⭐ 290 | 🐛 0 | 🌐 HTML | 📅 2026-02-25!
