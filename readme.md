...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 23 | 🐛 0 | 🌐 Shell | 📅 2026-04-11.
...
* [junzis/pyModeS](https://github.com/junzis/pyModeS) ⭐ 654 | 🐛 23 | 🌐 Python | 📅 2026-04-12 - A python decoder for Mode S and ADS-B signals.
