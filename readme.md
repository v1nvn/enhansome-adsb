...
* [adsb\_actions](https://github.com/eastham/adsb_actions) ⭐ 3 | 🐛 8 | 🌐 Python | 📅 2026-03-31 - Python tool to detect, act on, and visualize ADS-B traffic and events.

### Feeding

* [sdr-enthusiasts/docker-adsb-ultrafeeder](https://github.com/sdr-enthusiasts/docker-adsb-ultrafeeder) ⭐ 475 | 🐛 3 | 🌐 Shell | 📅 2026-01-28 - All-in-one ADSB container with readsb, tar1090, graphs1090, autogain, multi-feeder, and mlat-hub built in.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,731 | 🐛 53 | 🌐 JavaScript | 📅 2026-03-25 - A great way to view your ADS-B data.
