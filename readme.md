...
* [ADSB.lol](https://adsb.lol) - A completely open-source and community-driven flight tracker that displays and provides [ODbL-licensed](https://opendatacommons.org/licenses/odbl/summary/) data via a [free API](https://api.adsb.lol/) as well as [free historical data](https://github.com/adsblol/globe_history) ⭐ 27 | 🐛 1 | 🌐 Shell | 📅 2026-05-09.
...
* [sdr-enthusiasts/plane-alert-db](https://github.com/sdr-enthusiasts/plane-alert-db) ⭐ 129 | 🐛 9 | 🌐 Python | 📅 2026-05-09 - A list of exciting aircraft - Governments, Dictators, Military, Historical and just plain odd.
...
* [wiedehopf/tar1090](https://github.com/wiedehopf/tar1090) ⭐ 1,776 | 🐛 55 | 🌐 JavaScript | 📅 2026-05-07 - A great way to view your ADS-B data.
